...
DO $MIGR20260413$
BEGIN
  -- Already applied (or created manually)
  IF to_regclass('tenant.exams') IS NOT NULL THEN
    RAISE NOTICE '20260413000000 enable_multischema: tenant.exams present, skip';
    RETURN;
  END IF;

  -- Legacy: copy structure+data from public, then drop public tables
