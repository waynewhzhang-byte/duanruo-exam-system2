...
import { Form, FormField, FormItem, FormLabel, FormControl, FormMessage, Input, Textarea, Select, Checkbox, Radio } from '@/components/ui/form'
    ...
    <DashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">新建报名</h1>
            {selectedExam && selectedPosition ? (
              <p className="text-gray-600">
                {selectedExam.title} - {selectedPosition.title}
              </p>
            ) : (
              <p className="text-gray-600">请填写完整的报名信息</p>
            )}
          </div>
        </div>
